...
<template>
  <div v-if="loading" class="d-flex" style="height: 35rem">
    <div class="spinner-border m-auto text-primary" role="status">
      <span class="visually-hidden">Loading...</span>
    </div>
  </div>
  <div v-else-if="error" class="d-flex" style="height: 35rem">
  ...
  <div v-else class="row">
    <div v-for="item in products" :key="item.id" class="col-sm-12 col-md-4 col-lg-3 col-xl-2 mb-4">
      <ProductCard />
    </div>
  </div>
</template>
